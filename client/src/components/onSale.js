...
export default function AlertDialogSlide(props) {
  const {open, closeModal,handleOnSale, handleApprove,step,handlePrice,handleTime} = props;
      ...
      >
        ...
        <DialogActions id="x-connect-wallet-modal-footer">
            <div style = {step == "1"?{display:'block'}:{display:"none"}}>
                <div className = "mb-2 x-onsale-price">
                    <input type = "text" placeholder = "Enter price" onChange = {handlePrice} />
                    <input type = "date" onChange = {handleTime} />
                </div>
            ...
            <div style = {step == "2"?{display:'block'}:{display:"none"}}>
                <button className = "x-connect-wallet-modal-footer-button" onClick={handleOnSale}>
                    On Sale
                </button>
            </div>
        </DialogActions>
